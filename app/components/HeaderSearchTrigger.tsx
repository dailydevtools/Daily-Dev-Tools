...
export default function HeaderSearchTrigger() {
    ...
    return (
        <button
            ...
            className="flex items-center gap-2 py-2 px-3 bg-[var(--card-bg)] backdrop-blur-xl border border-[var(--border-color)] rounded-lg cursor-pointer min-h-[44px] w-full md:w-auto transition-all duration-300 hover:bg-[var(--card-hover-bg)] hover:border-[#f9731666] hover:-translate-y-0.5"
